...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Sep 05, 2024 at 09:31 PM
...
--
-- Table structure for table `products_v2`
--

CREATE TABLE `products_v2` (
  `id` int(11) NOT NULL,
  `descr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insert_time` datetime(6) DEFAULT NULL,
  `NAME` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `roles` (`id`, `name`, `description`, `id_role`) VALUES
(1, 'admin', NULL, 0),
(2, 'manager', NULL, 0),
(3, 'general_user', NULL, 0);
...
CREATE TABLE `users` (
  ...
  `created_ts` varbinary(255) DEFAULT NULL,
  `update_ts` varbinary(255) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `role_id`, `is_active`, `created_ts`, `update_ts`, `role`, `id_user`, `id_role`) VALUES
(1, 'John', 'aniskovichav@gmail.com', '/j/CD5RnMO6iekyDMLBe2A==', 2, 'Y', 0x323032342d30372d31362032303a32393a3430, NULL, 0, 0, NULL);
...
ALTER TABLE `items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK5gmqnywtapmeoyah4g3hqx9pq` (`cart_id`);
...
ALTER TABLE `users`
  ...
  ADD KEY `users_to_roles_fk_1` (`role_id`);
...
--
-- AUTO_INCREMENT for table `products_v2`
--
ALTER TABLE `products_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `items`
  ADD CONSTRAINT `FK5gmqnywtapmeoyah4g3hqx9pq` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`cart_id`);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_to_roles_fk_1` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`);
COMMIT;
